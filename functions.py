...
def alphatwin(message):
	embed = discord.Embed(title = "ALPHA TWIN", color = discord.Color.from_rgb(209, 170, 88))
	embed.add_field(name = "the alpha twin is:", value = "BEN", inline = True)
	embed.set_thumbnail(url = message.guild.get_member(612070962913083405).avatar_url)
	return embed
